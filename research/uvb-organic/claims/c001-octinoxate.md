# c001 — Octinoxate (Ethylhexyl Methoxycinnamate / EHMC / OMC)

## Section 1: Identity

| Field | Value | Confidence |
|---|---|---|
| INCI | Ethylhexyl Methoxycinnamate | C1 |
| IUPAC | 2-Ethylhexyl (2E)-3-(4-methoxyphenyl)prop-2-enoate | C1 |
| USAN | Octinoxate | C1 |
| Trade names | Parsol MCX, Eusolex 2292, Uvinul MC80, Escalol 557 | C1 |
| CAS | 5466-77-3 (also 83834-59-7 for the cis/trans mixture EC 629-661-9) | C1 |
| Molecular formula | C₁₈H₂₆O₃ | C1 |
| Molecular weight | 290.40 g·mol⁻¹ | C1 |
| EC number | 226-775-7 | C1 |

### Regulatory Status
| Jurisdiction | Status | Max conc. | Source / entry | Conf. |
|---|---|---|---|---|
| USA (FDA OTC monograph) | Permitted Cat. III | 7.5 % | 21 CFR 352.10(o) | C1 |
| EU (Annex VI) | Permitted, entry 12 | 10 % | Regulation 1223/2009 Annex VI; SCCS/1671/24 (June 2025) reaffirmed 10 % maximum | C1 |
| Australia (TGA) | Permitted | 10 % | TGA ARTG | C1 |
| Japan (PMDA) | Permitted | 20 % (one of the highest world-wide) | Standard for Cosmetics, MHLW notification 331 | C2 |
| Korea (MFDS) | Permitted | 7.5 % | KFDA Cosmetic Standard | C2 |
| ASEAN | Permitted, harmonised with EU at 10 % | 10 % | ASEAN Cosmetic Directive Annex VI | C2 |
| Hawaii / Palau / Thailand | **Banned** for reef protection | 0 % | Hawaii Act 104 (2018), Palau Act 2018, Thailand 2021 | C1 |

Typical use concentration: 2–10 % in sunscreen formulations; most common at 5–7.5 %.

## Section 2: UV Absorption Spectrum

Octinoxate is a UVB filter (280–320 nm) whose long-wavelength tail extends slightly into UVA II.
The molecule shows pronounced *solvatochromism* (the **trans** isomer's λmax shifts ~19 nm between cyclohexane and ethanol) and *photoisomerism* (the cis isomer is photogenerated and has a lower ε).
...
E(1%, 1cm) is not commonly reported for octinoxate because formulators normally cite ε; computed from ε = 24,000 / MW × 10 ≈ 826 (at 310 nm in EtOH) — **C3**.
...
| Methanol (330 nm) | 0.41 ± 0.05 | 0.52 ± 0.04 |
| Cyclohexane (solar) | 0.28 ± 0.01 | 0.60 ± 0.00 |
...
* **Synergy/antagonism:**
  ...
  * Modest **synergy with octocrylene** which can quench OMC's triplet [C1].
...
5. Pattanaargson S, Limphong-Pand P. Int J Cosmet Sci 23 (2001) 153-160.
6. Couteau C et al. "UV filters, ingredients with a recognized anti-inflammatory effect", Pharm Res 24 (2007) 1153-1160.
7. Schlumpf M et al. "In vitro and in vivo estrogenicity of UV screens". Environ Health Perspect 109 (2001) 239-244.
8. SCCS/1671/24 (final 30 June 2025) — Opinion on Ethylhexyl Methoxycinnamate.
9. Janjua NR et al. "Urinary excretion of phthalates and paraben after repeated whole-body topical application of cosmetics", Int J Androl 31 (2008) 118-130.
